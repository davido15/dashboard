...
//---------------Login ACTION-----(Single form process)---------

if (isset($_POST['u_login']) && isset($_POST['p_login'])) {
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://massive-glyph-338323.lm.r.appspot.com//app/login',
  ...
  CURLOPT_POSTFIELDS =>'{
	"password":"'.$p_login.'",   "email":"'.$u_login.'"
...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 18:14:01 GMT -->
<head>
    <meta charset="utf-8" />
  ...
  <g id="Pages" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Login---V2" transform="translate(-667.000000, -290.000000)">
      <g id="Login" transform="translate(519.000000, 244.000000)">
        ...
        <form id="type="submit"" class="mb-3" action="" method="POST">
          <div class="mb-3">
            <label for="email" class="form-label">Email or Username</label>
            <input type="text" class="form-control" id="email" name="u_login" placeholder="Enter your email or username" autofocus>
          </div>
          <div class="mb-3 form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              <input type="password" id="password" class="form-control" name="p_login" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 18:14:02 GMT -->
</html>
